...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUNC] = LAYOUT(
		...
		_______,   KC_NO,     _______,   KC_TTY,   _______,   _______,   KC_F4,   KC_F5,   KC_F6,   KC_F11,
	...
	[_NUM] = LAYOUT(
		_______,   KC_7,   KC_8,   KC_9,  KC_0,      _______,   _______,   _______,   _______,   _______,
		_______,   KC_4,   KC_5,   KC_6,  _______,   _______,   _______,   _______,   KC_NO,     _______,
