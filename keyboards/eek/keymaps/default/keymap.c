 ...
 */
 /*  [_BASE] = LAYOUT(
   ...
   [_BASE] = LAYOUT(
    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,         KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    \
    KC_A,    KC_S,    RGB_HUD,    RGB_HUI,    RGB_M_P,         KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, \
    KC_Z,    KC_X,    RGB_VAD,    RGB_VAI,    KC_B,         KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, \
                      RGB_SAD, RGB_SAI, RGB_MOD,         KC_BSPC, RAISE, OSM(MOD_LSFT)                 \
  ),
