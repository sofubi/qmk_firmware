...
#define _________________34_L2_____________________       LSFT_T(KC_A), LT(5, KC_S), LT(1, KC_D), LT(3, KC_F), KC_G
...
#define _________________34_R2_____________________       KC_H, LT(4, KC_J), LT(2, KC_K), LT(6, KC_L), LSFT_T(KC_SCLN)
#define _________________34_R3_____________________       KC_N, KC_M, LGUI_T(KC_COMM), LCTL_T(KC_DOT), KC_SLSH

#define _________________34_MOUSE_L1_______________       ___________________BLANK___________________
#define _________________34_MOUSE_L2_______________       _______, KC_BTN1, KC_NO, KC_BTN2, _______
#define _________________34_MOUSE_L3_______________       ___________________BLANK___________________
 
#define _________________34_MOUSE_R1_______________       _______, KC_BTN1, KC_WH_U, KC_BTN2, _______
#define _________________34_MOUSE_R2_______________       _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R
#define _________________34_MOUSE_R3_______________       _______, KC_WH_L, KC_WH_D, KC_WH_R, _______

#define _________________34_NAV_L1_________________       _______, _______, KC_PGUP, _______, _______
#define _________________34_NAV_L2_________________       KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, _______
#define _________________34_NAV_L3_________________       _______, KC_HOME, KC_PGDN, KC_END, _______
 
#define _________________34_NAV_R1_________________       ___________________BLANK___________________
#define _________________34_NAV_R2_________________       _______, KC_LALT, KC_NO, LCTL_T(KC_LGUI), _______
#define _________________34_NAV_R3_________________       ___________________BLANK___________________
